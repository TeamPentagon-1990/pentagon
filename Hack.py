...
menu = ["Home","Add patient Record","Show patient Records", "Search and Edit Patient","Delete Patients Record","Send_Mail"]
...
# Login with your email and password 
    From=st.text_input("FROM",key="from")
    password=st.text_input("PASSWORD",key="pd")
    ...
    if submit:
        msg = message("Detal", "patient_Record",file1,file2) 
